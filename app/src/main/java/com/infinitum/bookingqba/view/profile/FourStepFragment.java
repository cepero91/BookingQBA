...
public class FourStepFragment extends Fragment implements Step{

    private FragmentFourStepBinding binding;
    private OnStepFormEnd onStepFormEnd;

    public FourStepFragment(){}

    public static FourStepFragment newInstance(){
        return new FourStepFragment();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_four_step,container,false);
