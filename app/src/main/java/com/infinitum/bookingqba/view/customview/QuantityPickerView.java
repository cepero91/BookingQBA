...
public class QuantityPickerView extends LinearLayout {
    ...
    private AppCompatImageView mImageIncrement, mImageDecrement;
    ...
    public QuantityPickerView(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
        init(context, attrs);
    }
    /**
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mImageIncrement = (AppCompatImageView) this.findViewById(R.id.imageButtonIncrement);
        mImageIncrement.setOnClickListener(clickListener);
        mImageDecrement = (AppCompatImageView) this.findViewById(R.id.imageButtonDecrement);
