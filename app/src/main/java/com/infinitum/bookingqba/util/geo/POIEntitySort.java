...
public class POIEntitySort implements Comparator<PointOfInterest> {
    LatLong currentLoc;

    public POIEntitySort(LatLong current){
        currentLoc = current;
    }

    @Override
    public int compare(final PointOfInterest place1, final PointOfInterest place2) {
