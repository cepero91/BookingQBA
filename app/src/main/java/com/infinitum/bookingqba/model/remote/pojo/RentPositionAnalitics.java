...
public class RentPositionAnalitics {
    ...
    public RentPositionAnalitics(int totalNationalRent, int totalProvinceRent, int placeNationalRating, int placeProvinceRating, int placeNationalViews, int placeProvinceViews) {
